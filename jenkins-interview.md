Interview Question by Capgemini.

1. How to define JENKINS SHARED LIBRARIES ?

Jenkins-Zero-To-Hero > vars > mavenBuild.groovy
def call() {
...
2. What is JNLP ?
3. What is Endpoints?
4. How to connect Ec2 to S3 without NAT, IGw, or IAM?
--using Endpoint
5. Working is not able to connect from control plan. what could be the reason?
...
Q: What is shared modules in Jenkins ? --if there is a configuration changes which are commonly used by many pipleline.
